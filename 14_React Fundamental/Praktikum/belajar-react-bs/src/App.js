          ...
          <div className="container-fluid mx-3">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <a className="nav-link text-primary px-3 mx-2" href="#">
                    Features
                  </a>
                </li>
                <li className="nav-item">
      ...
      <>
        ...
        <footer className="container-fluid text-white">
          <div className="row p-5">
            <div className="col-md-4">
              ...
              <p data-aos="fade-right" data-aos-duration={1500}>
                (+62)882-2713-6649 <br />
                Surabaya, Jawa Timur, 60274
              </p>
            </div>
            <div className="col-md-4">
              <a href="https://ekabayu.vercel.app/">
                <h2 data-aos="fade-up" data-aos-duration={1500}>
                  EBayProject
                </h2>
              </a>
              <p data-aos="fade-up" data-aos-duration={2000}>
                Kunjungi personal landing page kami di{" "}
                <a href="https://ekabayu.vercel.app/">EBayProject</a>
                <br />
                yang berisi beberapa portofolio yang pernah kami buat.
              </p>
            </div>
            <div className="col-md-4" data-aos="fade-up" data-aos-duration={2250}>
              <h3>Tautan Media Sosial</h3>
              {/* Instagram */}
              <a href="https://www.instagram.com/ekabayu_12" target="_blank" rel="noreferrer">
                <svg role="img" width={20} viewBox="0 0 24 24 " fill="currentColor">
              ...
              <br />
              {/* Linkedin */}
              <a href="https://id.linkedin.com/in/eka-bayu-satriawan" target="_blank" rel="noreferrer">
                <svg role="img" width={20} viewBox="0 0 24 24" fill="currentColor">
          ...
          <p className="text-center">
            © 2023 | Made with ❤️{" "}
            <a
              href="https://instagram.com/ekabayu_12"
              target="_blank"
              className="font-bold text-primary" rel="noreferrer"
            >
              Eka Bayu Satriawan
            </a>
            , use <a href="https://getbootstrap.com/">Bootstrap</a> and{" "}
