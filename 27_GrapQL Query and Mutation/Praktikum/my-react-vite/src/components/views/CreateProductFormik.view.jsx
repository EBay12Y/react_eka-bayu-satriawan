...
const CreateProductFormik = () => {
    const {
        ...
        data: productsData,
    } = useQuery(RETRIEVE_PRODUCTS_QUERY);
    ...
    if (retrieveProducts || insertProductLoading || deleteProductByIdLoading) return <p>Loading...</p>;
    return (
        <>
            <Navbar />
            <ProductForm
            ...
            />
            <ProductList products={productsData?.product} handleDelete={handleDeleteProduct} />
        </>
    );
}
